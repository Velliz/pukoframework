...
class MemcachedDriver implements CacheItemPoolInterface
{
    /**
    ...
    public function getItems(array $keys = array())
    {
        ...
        if (false !== $values) {
            foreach ($keys as $key) {
                $items[$key] = isset($values[$key]) ? unserialize($values[$key]) : new Items($key);
            }
        }
        return $items;
    }
